...
void reach_error()
{
  __assert_fail("0", "float_req_bl_0550b.c", 3, "reach_error");
}
...
static const float one_krempio = 1.0;
static const float two8_krempio = 2.5600000000e+02;
static const float twon8_krempio = 3.9062500000e-03;
...
static const __int32_t two_over_pi_rempio[] = {};
static const __int32_t npio2_hw_rempio[] = {0x3fc90f00, 0x40490f00, 0x4096cb00, 0x40c90f00, 0x40fb5300, 0x4116cb00, 0x412fed00, 0x41490f00, 0x41623100, 0x417b5300, 0x418a3a00, 0x4196cb00, 0x41a35c00, 0x41afed00, 0x41bc7e00, 0x41c90f00, 0x41d5a000, 0x41e23100, 0x41eec200, 0x41fb5300, 0x4203f200, 0x420a3a00, 0x42108300, 0x4216cb00, 0x421d1400, 0x42235c00, 0x4229a500, 0x422fed00, 0x42363600, 0x423c7e00, 0x4242c700, 0x42490f00};
static const float zero_rempio = 0.0000000000e+00;
static const float half_rempio = 5.0000000000e-01;
static const float two8_rempio = 2.5600000000e+02;
static const float invpio2_rempio = 6.3661980629e-01;
static const float pio2_1_rempio = 1.5707855225e+00;
static const float pio2_1t_rempio = 1.0804334124e-05;
static const float pio2_2_rempio = 1.0804273188e-05;
static const float pio2_2t_rempio = 6.0770999344e-11;
static const float pio2_3_rempio = 6.0770943833e-11;
static const float pio2_3t_rempio = 6.1232342629e-17;
__int32_t __ieee754_rem_pio2f(float x, float *y)
{
  ...
  if (ix <= 0x43490f80)
  {
    ...
    w = fn * pio2_1t_rempio;
    if (__logand(n < 32, (ix & 0xffffff00) != npio2_hw_rempio[n - 1]))
    {
      y[0] = r - w;
    }
    else
...
static const float pio4_ktan = 7.8539812565e-01;
static const float pio4lo_ktan = 3.7748947079e-08;
static const float T_ktan[] = {3.3333334327e-01, 1.3333334029e-01, 5.3968254477e-02, 2.1869488060e-02, 8.8632395491e-03, 3.5920790397e-03, 1.4562094584e-03, 5.8804126456e-04, 2.4646313977e-04, 7.8179444245e-05, 7.1407252108e-05, -1.8558637748e-05, 2.5907305826e-05};
