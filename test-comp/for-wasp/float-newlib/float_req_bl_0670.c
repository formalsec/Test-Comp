...
void reach_error()
{
  __assert_fail("0", "float_req_bl_0670.c", 3, "reach_error");
}
...
static const float atanhi_atan[] = {4.6364760399e-01, 7.8539812565e-01, 9.8279368877e-01, 1.5707962513e+00};
static const float atanlo_atan[] = {5.0121582440e-09, 3.7748947079e-08, 3.4473217170e-08, 7.5497894159e-08};
static const float aT_atan[] = {3.3333334327e-01, -2.0000000298e-01, 1.4285714924e-01, -1.1111110449e-01, 9.0908870101e-02, -7.6918758452e-02, 6.6610731184e-02, -5.8335702866e-02, 4.9768779427e-02, -3.6531571299e-02, 1.6285819933e-02};
...
static const float pi_lo_atan2 = -8.7422776573e-08;
...
int main()
{
  ...
  if (__logor(isnan_float(x), isnan_float(y)))
  {
