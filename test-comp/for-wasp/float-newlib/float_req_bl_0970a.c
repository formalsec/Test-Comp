...
void reach_error()
{
  __assert_fail("0", "float_req_bl_0970a.c", 3, "reach_error");
}
...
static const float ivln10_log10 = 4.3429449201e-01;
static const float log10_2hi_log10 = 3.0102920532e-01;
static const float log10_2lo_log10 = 7.9034151668e-07;
...
int main()
{
  ...
  if (__logand(x < 0, isfinite_float(x)))
  {
