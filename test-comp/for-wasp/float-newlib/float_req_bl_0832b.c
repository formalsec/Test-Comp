...
void reach_error()
{
  __assert_fail("0", "float_req_bl_0832b.c", 3, "reach_error");
}
...
static const float halF_exp[2] = {0.5, -0.5};
static const float huge_exp = 1.0e+30;
static const float twom100_exp = 7.8886090522e-31;
static const float ln2HI_exp[2] = {6.9313812256e-01, -6.9313812256e-01};
static const float ln2LO_exp[2] = {9.0580006145e-06, -9.0580006145e-06};
...
float __ieee754_expf(float x)
{
  ...
  if (__logand(sx < 0, hx > 0x42cff1b5))
