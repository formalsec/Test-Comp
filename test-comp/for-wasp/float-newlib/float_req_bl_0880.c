...
void reach_error()
{
  __assert_fail("0", "float_req_bl_0880.c", 3, "reach_error");
}
...
float fmod_float(float x, float y)
{
  ...
  hx ^= sx;
  hy &= 0x7fffffff;
  if (__logor(__logor(hy == 0, !(hx < 0x7f800000L)), hy > 0x7f800000L))
    return (x * y) / (x * y);
...
static const float dp_h_pow[] = {0.0, 5.84960938e-01};
static const float dp_l_pow[] = {0.0, 1.56322085e-06};
static const float zero_pow = 0.0;
static const float one_pow = 1.0;
static const float two_pow = 2.0;
static const float two24_pow = 16777216.0;
static const float huge_pow = 1.0e30;
static const float tiny_pow = 1.0e-30;
static const float L1_pow = 6.0000002384e-01;
static const float L2_pow = 4.2857143283e-01;
static const float L3_pow = 3.3333334327e-01;
static const float L4_pow = 2.7272811532e-01;
static const float L5_pow = 2.3066075146e-01;
static const float L6_pow = 2.0697501302e-01;
static const float P1_pow = 1.6666667163e-01;
static const float P2_pow = -2.7777778450e-03;
static const float P3_pow = 6.6137559770e-05;
static const float P4_pow = -1.6533901999e-06;
static const float P5_pow = 4.1381369442e-08;
static const float lg2_pow = 6.9314718246e-01;
static const float lg2_h_pow = 6.93145752e-01;
static const float lg2_l_pow = 1.42860654e-06;
static const float ovt_pow = 4.2995665694e-08;
static const float cp = 9.6179670095e-01;
static const float cp_h_pow = 9.6179199219e-01;
static const float cp_l_pow = 4.7017383622e-06;
static const float ivln2_pow = 1.4426950216e+00;
static const float ivln2_h_pow = 1.4426879883e+00;
static const float ivln2_l_pow = 7.0526075433e-06;
float __ieee754_powf(float x, float y)
{
  ...
  if (__logor(ix > 0x7f800000L, iy > 0x7f800000L))
  {
    if (ix == 0x3f800000)
      return one_pow;
    else
  ...
  ax = fabs_float(x);
  if (__logor(__logor(ix == 0x7f800000L, ix == 0), ix == 0x3f800000))
  {
    z = ax;
    if (hy < 0)
      z = one_pow / z;
...
int main()
{
  ...
  if (__logand(__logand(y > 0, isinteger_float(y)), fmod_float(y, 2.0f) == 1.0f))
  {
