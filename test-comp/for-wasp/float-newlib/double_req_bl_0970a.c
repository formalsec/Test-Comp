...
void reach_error()
{
  __assert_fail("0", "double_req_bl_0970a.c", 3, "reach_error");
}
...
static const double ivln10_log10 = 4.34294481903251816668e-01;
static const double log10_2hi_log10 = 3.01029995663611771306e-01;
static const double log10_2lo_log10 = 3.69423907715893078616e-13;
...
int main()
{
  ...
  if (__logand(x < 0, isfinite_double(x)))
  {
