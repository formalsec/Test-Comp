...
void reach_error()
{
  __assert_fail("0", "pals_lcr.8_overflow.ufo.UNBOUNDED.pals.c", 3, "reach_error");
}
...
void node6(void)
{
  msg_t m6;
  {
    ...
    {
      p6_new = (__logand(send6 != nomsg, p6_new == nomsg)) ? (send6) : (p6_new);
      mode6 = (_Bool) 1;
    }
...
void node7(void)
{
  msg_t m7;
  {
    ...
    {
      p7_new = (__logand(send7 != nomsg, p7_new == nomsg)) ? (send7) : (p7_new);
      mode7 = (_Bool) 1;
    }
...
void node8(void)
{
  msg_t m8;
  {
    ...
    {
      p8_new = (__logand(send8 != nomsg, p8_new == nomsg)) ? (send8) : (p8_new);
      mode8 = (_Bool) 1;
    }
...
void (*nodes[8])(void) = {&node1, &node2, &node3, &node4, &node5, &node6, &node7, &node8};
int init(void)
{
  int tmp;
  {
...
int main(void)
{
  ...
  int i2;
  {
    ...
    id6 = __VERIFIER_nondet_char("id6");
    st6 = __VERIFIER_nondet_char("st6");
    send6 = __VERIFIER_nondet_char("send6");
    mode6 = __VERIFIER_nondet_bool("mode6");
    id7 = __VERIFIER_nondet_char("id7");
    st7 = __VERIFIER_nondet_char("st7");
    send7 = __VERIFIER_nondet_char("send7");
    mode7 = __VERIFIER_nondet_bool("mode7");
    id8 = __VERIFIER_nondet_char("id8");
    st8 = __VERIFIER_nondet_char("st8");
    send8 = __VERIFIER_nondet_char("send8");
    mode8 = __VERIFIER_nondet_bool("mode8");
    i2 = init();
