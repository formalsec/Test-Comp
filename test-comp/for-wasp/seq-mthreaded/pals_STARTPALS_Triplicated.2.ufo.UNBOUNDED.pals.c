...
void reach_error()
{
  __assert_fail("0", "pals_STARTPALS_Triplicated.2.ufo.UNBOUNDED.pals.c", 3, "reach_error");
}
...
extern msg_t __VERIFIER_nondet_char(char *);
extern void abort(void);
...
void gate1_each_pals_period(void)
{
  ...
  int tmp___0;
  {
    gate1Failed = __VERIFIER_nondet_bool("gate1Failed");
    write_history_bool(0, gate1Failed);
    if (gate1Failed)
    {
      g1v_new = (__logand(nomsg != nomsg, g1v_new == nomsg)) ? (nomsg) : (g1v_new);
      return;
    }
    ...
    assume_abort_if_not((_Bool) tmp___0);
    g1v_new = (__logand(next_state != nomsg, g1v_new == nomsg)) ? (next_state) : (g1v_new);
    return;
  }
}
...
void gate2_each_pals_period(void)
{
  ...
  int tmp___0;
  {
    gate2Failed = __VERIFIER_nondet_bool("gate2Failed");
    write_history_bool(1, gate2Failed);
    if (gate2Failed)
    {
      g2v_new = (__logand(nomsg != nomsg, g2v_new == nomsg)) ? (nomsg) : (g2v_new);
      return;
    }
    ...
    assume_abort_if_not((_Bool) tmp___0);
    g2v_new = (__logand(next_state != nomsg, g2v_new == nomsg)) ? (next_state) : (g2v_new);
    return;
  }
}
...
void gate3_each_pals_period(void)
{
  ...
  int tmp___0;
  {
    gate3Failed = __VERIFIER_nondet_bool("gate3Failed");
    write_history_bool(2, gate3Failed);
    if (gate3Failed)
    {
      g3v_new = (__logand(nomsg != nomsg, g3v_new == nomsg)) ? (nomsg) : (g3v_new);
      return;
    }
    ...
    assume_abort_if_not((_Bool) tmp___0);
    g3v_new = (__logand(next_state != nomsg, g3v_new == nomsg)) ? (next_state) : (g3v_new);
    return;
  }
}
...
int main(void)
{
  ...
  int i2;
  {
    ...
    gate2Failed = __VERIFIER_nondet_bool("gate2Failed");
    gate3Failed = __VERIFIER_nondet_bool("gate3Failed");
    VALUE1 = __VERIFIER_nondet_char("VALUE1");
    VALUE2 = __VERIFIER_nondet_char("VALUE2");
    VALUE3 = __VERIFIER_nondet_char("VALUE3");
    gate1Failed_History_0 = __VERIFIER_nondet_bool("gate1Failed_History_0");
    gate1Failed_History_1 = __VERIFIER_nondet_bool("gate1Failed_History_1");
    gate1Failed_History_2 = __VERIFIER_nondet_bool("gate1Failed_History_2");
    gate2Failed_History_0 = __VERIFIER_nondet_bool("gate2Failed_History_0");
    gate2Failed_History_1 = __VERIFIER_nondet_bool("gate2Failed_History_1");
    gate2Failed_History_2 = __VERIFIER_nondet_bool("gate2Failed_History_2");
    gate3Failed_History_0 = __VERIFIER_nondet_bool("gate3Failed_History_0");
    gate3Failed_History_1 = __VERIFIER_nondet_bool("gate3Failed_History_1");
    gate3Failed_History_2 = __VERIFIER_nondet_bool("gate3Failed_History_2");
    votedValue_History_0 = __VERIFIER_nondet_char("votedValue_History_0");
    votedValue_History_1 = __VERIFIER_nondet_char("votedValue_History_1");
    votedValue_History_2 = __VERIFIER_nondet_char("votedValue_History_2");
    i2 = init();
