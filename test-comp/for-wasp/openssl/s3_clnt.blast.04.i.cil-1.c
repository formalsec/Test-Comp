...
void reach_error() { __assert_fail("0", "s3_clnt.blast.04.i.cil-1.c", 3, "reach_error"); }
...
{ BUF_MEM *buf ;
  ...
  long tmp___9 = __VERIFIER_nondet_long("tmp___9") ;
  int blastFlag ;
                                                                    ...
                                                                    if (s->state == 3) {
                                                                      ...
                                                                      if (0) {
                                                                        ...
                                                                        if ((unsigned long )s->init_buf == (unsigned long )((void *)0)) {
                                                                          buf = (BUF_MEM *) __VERIFIER_nondet_ulong("buf");
