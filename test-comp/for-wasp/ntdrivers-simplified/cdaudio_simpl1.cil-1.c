...
int SendSrbSynchronous(int Extension, int Srb, int Buffer, int BufferLength)
{
  int ioStatus__Status = __VERIFIER_nondet_int("ioStatus__Status");
  int ioctl;
  int event = __VERIFIER_nondet_int("event");
  int irp;
  int status = __VERIFIER_nondet_int("status");
  int __cil_tmp10;
  int __cil_tmp11;
  int __cil_tmp12;
  int __cil_tmp13;
...
int CdAudioStartDevice(int DeviceObject, int Irp)
{
  int deviceExtension__Active = __VERIFIER_nondet_int("deviceExtension__Active");
  int deviceExtension = __VERIFIER_nondet_int("deviceExtension");
  int status;
  int srb = __VERIFIER_nondet_int("srb");
  int srb__Cdb = __VERIFIER_nondet_int("srb__Cdb");
  int cdb;
  int inquiryDataPtr;
  int attempt;
  int tmp;
  int deviceParameterHandle = __VERIFIER_nondet_int("deviceParameterHandle");
  int keyValue;
  {
    {
...
int CdAudioPnp(int DeviceObject, int Irp)
{
  ...
  int irpSp__Parameters__UsageNotification__Type = __VERIFIER_nondet_int("irpSp__Parameters__UsageNotification__Type");
  int deviceExtension__PagingPathCountEvent = __VERIFIER_nondet_int("deviceExtension__PagingPathCountEvent");
  int irpSp__Parameters__UsageNotification__InPath = __VERIFIER_nondet_int("irpSp__Parameters__UsageNotification__InPath");
  int deviceExtension__PagingPathCount = __VERIFIER_nondet_int("deviceExtension__PagingPathCount");
...
int CdAudioSendToNextDriver(int DeviceObject, int Irp)
{
  ...
  int Irp__Tail__Overlay__CurrentStackLocation = __VERIFIER_nondet_int("Irp__Tail__Overlay__CurrentStackLocation");
  int deviceExtension__TargetDeviceObject = __VERIFIER_nondet_int("deviceExtension__TargetDeviceObject");
  int tmp;
  {
    if (s == NP)
    {
...
int CdAudioIsPlayActive(int DeviceObject)
{
  int deviceExtension__PlayActive = __VERIFIER_nondet_int("deviceExtension__PlayActive");
  int ioStatus__Status = __VERIFIER_nondet_int("ioStatus__Status");
  int currentBuffer__Header__AudioStatus = __VERIFIER_nondet_int("currentBuffer__Header__AudioStatus");
  int irp_CdAudioIsPlayActive = __VERIFIER_nondet_int("irp_CdAudioIsPlayActive");
  int event = __VERIFIER_nondet_int("event");
  int status = __VERIFIER_nondet_int("status");
  int currentBuffer = __VERIFIER_nondet_int("currentBuffer");
  int returnValue;
  long __cil_tmp10;
  int __cil_tmp11;
  {
...
int CdAudio535DeviceControl(int DeviceObject, int Irp)
{
  ...
  int srb__Cdb = __VERIFIER_nondet_int("srb__Cdb");
  int currentIrpStack__Parameters__DeviceIoControl__IoControlCode = __VERIFIER_nondet_int("currentIrpStack__Parameters__DeviceIoControl__IoControlCode");
  int Irp__IoStatus__Information;
  int currentIrpStack__Parameters__DeviceIoControl__OutputBufferLength = __VERIFIER_nondet_int("currentIrpStack__Parameters__DeviceIoControl__OutputBufferLength");
  int currentIrpStack__Parameters__DeviceIoControl__InputBufferLength = __VERIFIER_nondet_int("currentIrpStack__Parameters__DeviceIoControl__InputBufferLength");
  int srb__CdbLength;
  int cdb__CDB10__OperationCode;
  int srb__TimeOutValue;
  int sizeof__READ_CAPACITY_DATA = __VERIFIER_nondet_int("sizeof__READ_CAPACITY_DATA");
  int lastSession__LogicalBlockAddress = __VERIFIER_nondet_int("lastSession__LogicalBlockAddress");
  int cdaudioDataOut__FirstTrack = __VERIFIER_nondet_int("cdaudioDataOut__FirstTrack");
  int cdaudioDataOut__LastTrack = __VERIFIER_nondet_int("cdaudioDataOut__LastTrack");
  int sizeof__CDROM_TOC = __VERIFIER_nondet_int("sizeof__CDROM_TOC");
  int sizeof__SUB_Q_CURRENT_POSITION = __VERIFIER_nondet_int("sizeof__SUB_Q_CURRENT_POSITION");
  int userPtr__Format = __VERIFIER_nondet_int("userPtr__Format");
  int sizeof__CDROM_PLAY_AUDIO_MSF = __VERIFIER_nondet_int("sizeof__CDROM_PLAY_AUDIO_MSF");
  int inputBuffer__StartingM = __VERIFIER_nondet_int("inputBuffer__StartingM");
  int inputBuffer__EndingM = __VERIFIER_nondet_int("inputBuffer__EndingM");
  int inputBuffer__StartingS = __VERIFIER_nondet_int("inputBuffer__StartingS");
  int inputBuffer__EndingS = __VERIFIER_nondet_int("inputBuffer__EndingS");
  int inputBuffer__StartingF = __VERIFIER_nondet_int("inputBuffer__StartingF");
  int inputBuffer__EndingF = __VERIFIER_nondet_int("inputBuffer__EndingF");
  int cdb__PLAY_AUDIO_MSF__OperationCode = __VERIFIER_nondet_int("cdb__PLAY_AUDIO_MSF__OperationCode");
  int sizeof__CDROM_SEEK_AUDIO_MSF = __VERIFIER_nondet_int("sizeof__CDROM_SEEK_AUDIO_MSF");
  int currentIrpStack;
  int deviceExtension;
  int cdaudioDataOut;
  int srb = __VERIFIER_nondet_int("srb");
  int lastSession = __VERIFIER_nondet_int("lastSession");
  int cdb;
  int status;
  int i = __VERIFIER_nondet_int("i");
  int bytesTransfered = __VERIFIER_nondet_int("bytesTransfered");
  int Toc = __VERIFIER_nondet_int("Toc");
  int tmp;
  int tmp___0;
  int tmp___1;
  int tmp___2;
  ...
  int tracksInBuffer;
  int userPtr;
  int SubQPtr = __VERIFIER_nondet_int("SubQPtr");
  int tmp___5;
  int tmp___6;
  int inputBuffer;
  int inputBuffer___0;
...
int CdAudio435DeviceControl(int DeviceObject, int Irp)
{
  ...
  int currentIrpStack__Parameters__DeviceIoControl__OutputBufferLength = __VERIFIER_nondet_int("currentIrpStack__Parameters__DeviceIoControl__OutputBufferLength");
  int currentIrpStack__Parameters__DeviceIoControl__InputBufferLength = __VERIFIER_nondet_int("currentIrpStack__Parameters__DeviceIoControl__InputBufferLength");
  int TrackData__0 = __VERIFIER_nondet_int("TrackData__0");
  int Irp__IoStatus__Information;
  int srb__TimeOutValue;
  int srb__CdbLength;
  int sizeof__CDROM_TOC = __VERIFIER_nondet_int("sizeof__CDROM_TOC");
  ...
  int sizeof__CDROM_PLAY_AUDIO_MSF = __VERIFIER_nondet_int("sizeof__CDROM_PLAY_AUDIO_MSF");
  int sizeof__CDROM_SEEK_AUDIO_MSF = __VERIFIER_nondet_int("sizeof__CDROM_SEEK_AUDIO_MSF");
  int deviceExtension__Paused = __VERIFIER_nondet_int("deviceExtension__Paused");
  int deviceExtension__PlayActive;
  int sizeof__SUB_Q_CHANNEL_DATA = __VERIFIER_nondet_int("sizeof__SUB_Q_CHANNEL_DATA");
  int sizeof__SUB_Q_CURRENT_POSITION = __VERIFIER_nondet_int("sizeof__SUB_Q_CURRENT_POSITION");
  int deviceExtension = __VERIFIER_nondet_int("deviceExtension");
  int srb = __VERIFIER_nondet_int("srb");
  int status;
  ...
  int SubQPtr = __VERIFIER_nondet_int("SubQPtr");
  int userPtr__Format = __VERIFIER_nondet_int("userPtr__Format");
  int SubQPtr___0 = __VERIFIER_nondet_int("SubQPtr___0");
  int tmp___0;
  int tmp___1;
  int tmp___2;
  int __cil_tmp35;
...
{
  int index = __VERIFIER_nondet_int("index");
  {
    if (index)
    {
      index--;
...
int HPCdrCompletion(int DeviceObject, int Irp, int Context)
{
  int Irp__PendingReturned = __VERIFIER_nondet_int("Irp__PendingReturned");
  int Irp__AssociatedIrp__SystemBuffer = __VERIFIER_nondet_int("Irp__AssociatedIrp__SystemBuffer");
  {
