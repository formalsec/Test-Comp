...
void *thr1()
{
  ...
  while (__logand(flag2[__CS_round] == 1, turn[__CS_round] == 1))
  {
    __CS_cs();
    if (__CS_ret != 0)
      return 0;
...
void *thr2()
{
  ...
  while (__logand(flag1[__CS_round] == 1, turn[__CS_round] == 0))
  {
    __CS_cs();
    if (__CS_ret != 0)
      return 0;
...
int main()
{
  ...
  for (i = 0; i < 3; i++)
  {
    ...
    __CS_cp_turn[i] = __VERIFIER_nondet_int("__CS_cp_turn[i]");
