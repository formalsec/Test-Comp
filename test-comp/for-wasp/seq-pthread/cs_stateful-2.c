...
void *main_thread(void *arg)
{
  ...
  if (__logand(data1[__CS_round] != 16, data2[__CS_round] != 5))
  {
    __CS_cs();
    if (__CS_ret != 0)
      return 0;
...
int main()
{
  ...
  for (i = 0; i < 2; i++)
  {
    __CS_cp_ma[i] = __VERIFIER_nondet_uchar("__CS_cp_ma[i]");
    __CS_cp_mb[i] = __VERIFIER_nondet_uchar("__CS_cp_mb[i]");
    __CS_cp_data1[i] = __VERIFIER_nondet_int("__CS_cp_data1[i]");
    __CS_cp_data2[i] = __VERIFIER_nondet_int("__CS_cp_data2[i]");
    for (j = 0; j < 3; j++)
    {
