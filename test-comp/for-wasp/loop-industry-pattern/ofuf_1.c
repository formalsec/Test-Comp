...
void reach_error()
{
  __assert_fail("0", "ofuf_1.c", 3, "reach_error");
}
...
extern int strcmp(const char *Id_MCDC_98, const char *Id_MCDC_99);
...
void Id_MCDC_117();
void Id_MCDC_118();
extern FILE *fopen(const char *Id_MCDC_119, const char *Id_MCDC_120);
int main();
...
UINT32 Id_MCDC_107(UINT16 Id_MCDC_100, UINT8 Id_MCDC_101, UINT32 *Id_MCDC_102, UINT32 *Id_MCDC_103, INT32 *Id_MCDC_104, void *Id_MCDC_105, UINT8 Id_MCDC_106)
{
  ...
  if (__logor(__logand(((UINT16) Id_MCDC_100) > ((UINT16) Id_MCDC_123), ((UINT16) Id_MCDC_100) <= ((UINT16) 0x19FF)), __logand(((UINT16) Id_MCDC_100) > ((UINT16) Id_MCDC_124), ((UINT16) Id_MCDC_100) <= ((UINT16) 0x15FF))))
  {
    if (Id_MCDC_101 == 0x01)
    {
      return 0x00;
  ...
  if (__logand(__logor(Id_MCDC_101 == 0, Id_MCDC_101 < Id_MCDC_134->Id_MCDC_0->Id_MCDC_88), strcmp((Id_MCDC_134->Id_MCDC_0->Id_MCDC_89 + Id_MCDC_101)->Id_MCDC_92, "rsvd")))
  {
...
static UINT32 Id_MCDC_110(UINT32 Id_MCDC_108, UINT32 Id_MCDC_109)
{
  ...
  while (Id_MCDC_137 != 0)
  {
    ...
    "32_39888_4294972284", __VERIFIER_assert(__logand(((long long) (Id_MCDC_135 / Id_MCDC_136)) >= 0, ((long long) (Id_MCDC_135 / Id_MCDC_136)) <= 4294967295)), Id_MCDC_138 = (UINT32) (Id_MCDC_135 / Id_MCDC_136);
...
void Id_MCDC_117()
{
  ...
  {
    if (__logand(Id_MCDC_131.Id_MCDC_66->Id_MCDC_42[Id_MCDC_158].Id_MCDC_34 <= 240, Id_MCDC_131.Id_MCDC_66->Id_MCDC_42[Id_MCDC_158].Id_MCDC_34 >= 1))
    {
