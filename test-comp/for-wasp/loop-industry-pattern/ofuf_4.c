...
void reach_error()
{
  __assert_fail("0", "ofuf_4.c", 3, "reach_error");
}
...
static UINT32 Id_MCDC_95(UINT32 Id_MCDC_93, CHAR *Id_MCDC_94)
{
  ...
  return "35_39854_4294972318", __VERIFIER_assert(__logand(((long long) ((Id_MCDC_94[0] * Id_MCDC_122) / Id_MCDC_121)) >= 0, ((long long) ((Id_MCDC_94[0] * Id_MCDC_122) / Id_MCDC_121)) <= 4294967295)), (Id_MCDC_94[0] * Id_MCDC_122) / Id_MCDC_121;
}
