...
void reach_error()
{
  __assert_fail("0", "ofuf_3.c", 3, "reach_error");
}
...
static UINT32 Id_MCDC_92(UINT32 Id_MCDC_90, UINT32 Id_MCDC_91)
{
  ...
  while (Id_MCDC_119 != 0)
  {
    ...
    "34_39889_4294972292", __VERIFIER_assert(__logand(((long long) (Id_MCDC_120 * Id_MCDC_118)) >= 0, ((long long) (Id_MCDC_120 * Id_MCDC_118)) <= 4294967295)), Id_MCDC_119 = Id_MCDC_117 - (Id_MCDC_120 * Id_MCDC_118);
