...
void reach_error()
{
  __assert_fail("0", "ofuf_2.c", 3, "reach_error");
}
...
extern int strcmp(const char *Id_MCDC_80, const char *Id_MCDC_81);
...
void Id_MCDC_99();
void Id_MCDC_100();
extern FILE *fopen(const char *Id_MCDC_101, const char *Id_MCDC_102);
int main();
...
UINT32 Id_MCDC_89(UINT16 Id_MCDC_82, UINT8 Id_MCDC_83, UINT32 *Id_MCDC_84, UINT32 *Id_MCDC_85, INT32 *Id_MCDC_86, void *Id_MCDC_87, UINT8 Id_MCDC_88)
{
  ...
  if (__logor(__logand(((UINT16) Id_MCDC_82) > ((UINT16) Id_MCDC_105), ((UINT16) Id_MCDC_82) <= ((UINT16) 0x19FF)), __logand(((UINT16) Id_MCDC_82) > ((UINT16) Id_MCDC_106), ((UINT16) Id_MCDC_82) <= ((UINT16) 0x15FF))))
  {
    if (Id_MCDC_83 == 0x01)
    {
      return 0x00;
  ...
  if (__logand(__logor(Id_MCDC_83 == 0, Id_MCDC_83 < Id_MCDC_116->Id_MCDC_0->Id_MCDC_70), strcmp((Id_MCDC_116->Id_MCDC_0->Id_MCDC_71 + Id_MCDC_83)->Id_MCDC_74, "rsvd")))
  {
...
static UINT32 Id_MCDC_92(UINT32 Id_MCDC_90, UINT32 Id_MCDC_91)
{
  ...
  while (Id_MCDC_119 != 0)
  {
    ...
    "33_39889_4294972293", __VERIFIER_assert(__logand(((long long) (Id_MCDC_117 - (Id_MCDC_120 * Id_MCDC_118))) >= 0, ((long long) (Id_MCDC_117 - (Id_MCDC_120 * Id_MCDC_118))) <= 4294967295)), Id_MCDC_119 = Id_MCDC_117 - (Id_MCDC_120 * Id_MCDC_118);
...
void Id_MCDC_99()
{
  ...
  {
    if (__logand(Id_MCDC_113.Id_MCDC_66->Id_MCDC_42[Id_MCDC_140].Id_MCDC_34 <= 240, Id_MCDC_113.Id_MCDC_66->Id_MCDC_42[Id_MCDC_140].Id_MCDC_34 >= 1))
    {
