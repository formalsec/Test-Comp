...
{ DRIVER_OBJECT d ;
  ...
  for (a = 0; a < sizeof(CD_DEVICE_EXTENSION); a++)
	  ((char *)devobj.DeviceExtension)[a] = __VERIFIER_nondet_char("1");
  for (a = 0; a < sizeof(IO_STACK_LOCATION); a++)
	  ((char *)irp.Tail.Overlay.__annonCompField17.__annonCompField16.CurrentStackLocation)[a] = __VERIFIER_nondet_char("2");
  for (a = 0; a < sizeof(CDROM_TOC); a++)
	  ((char *)irp.AssociatedIrp.SystemBuffer)[a] = __VERIFIER_nondet_char("3");
...
{ int __BLAST_NONDET___0 = __VERIFIER_nondet_int("__BLAST_NONDET___0") ;
  NTSTATUS returnVal2 ;
  int compRetStatus = __VERIFIER_nondet_int("compRetStatus");
  PVOID lcontext = 0 ;
  NTSTATUS tmp ;
  NTSTATUS tmp___0 ;
