...
int main()
{
  ...
  while (1)
  {
    index = (signed long long) __VERIFIER_nondet_short("index");
    pivot = (signed long long) __VERIFIER_nondet_short("pivot");
    assume_abort_if_not(pivot > 0);
    assume_abort_if_not(__logand(index >= pivot, index < (ARR_SIZE - pivot)));
