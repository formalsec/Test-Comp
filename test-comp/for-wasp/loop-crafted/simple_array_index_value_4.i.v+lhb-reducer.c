...
void reach_error()
{
  __assert_fail("0", "simple_array_index_value_4.i.v+lhb-reducer.c", 4, "reach_error");
}
...
int main()
{
  ...
  main__index1 = __VERIFIER_nondet_uint("main__index1");
  if (main__index1 < 100000)
  {
    main__index2 = __VERIFIER_nondet_uint("main__index2");
