...
int test_fun(int x, int y, int z)
{
  ...
  *z_ref = z;
  *c = 0;
  while (__logand(__logand(__logand(__logor(__logand((*y_ref) >= 0, (*z_ref) < (2147483647 - (*y_ref))), __logand((*y_ref) < 0, (*z_ref) > ((-2147483648) - (*y_ref)))), (*x_ref) > ((*y_ref) + (*z_ref))), (*y_ref) < 2147483647), (*z_ref) < 2147483647))
  {
    *y_ref = (*y_ref) + 1;
    *z_ref = (*z_ref) + 1;
  }
