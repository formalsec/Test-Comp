...
void reach_error()
{
  __assert_fail("0", "apache-escape-absolute.i.v+cfa-reducer.c", 4, "reach_error");
}
...
int main()
{
  ...
  int main__cp;
  int main__c;
  main__urilen = __VERIFIER_nondet_int("main__urilen");
  main__tokenlen = __VERIFIER_nondet_int("main__tokenlen");
  main__scheme = __VERIFIER_nondet_int("main__scheme");
                          ...
                          {
                            {
                              ...
                              else
                              {
                                ...
                                main____CPAchecker_TMP_0 = __VERIFIER_nondet_int("main____CPAchecker_TMP_0");
                                    ...
                                    {
                                      {
                                        ...
                                        else
                                        {
                                          ...
                                          if (main__cp != (main__urilen - 1))
                                          {
                                            ...
                                            main____CPAchecker_TMP_1 = __VERIFIER_nondet_int("main____CPAchecker_TMP_1");
                                                          ...
                                                          {
                                                            {
                                                              ...
                                                              else
                                                              {
                                                                ...
                                                                else
                                                                {
                                                                  ...
                                                                  main____CPAchecker_TMP_2 = __VERIFIER_nondet_int("main____CPAchecker_TMP_2");
                                                                                  ...
                                                                                  {
                                                                                    {
                                                                                      ...
                                                                                      else
                                                                                      {
                                                                                        ...
                                                                                        main____CPAchecker_TMP_3 = __VERIFIER_nondet_int("main____CPAchecker_TMP_3");
