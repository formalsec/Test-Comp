...
int main()
{
  ...
  int main__t;
  main__tagbuf_len = __VERIFIER_nondet_int("main__tagbuf_len");
              ...
              else
              {
                ...
                else
                {
                  ...
                  if (!(main____CPAchecker_TMP_3 == 0))
                  {
                    ...
                    main____CPAchecker_TMP_4 = __VERIFIER_nondet_int("main____CPAchecker_TMP_4");
                  ...
                  else
                  {
                    ...
                    main____CPAchecker_TMP_6 = __VERIFIER_nondet_int("main____CPAchecker_TMP_6");
