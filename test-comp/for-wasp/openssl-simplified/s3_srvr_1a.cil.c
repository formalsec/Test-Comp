...
void reach_error()
{
  __assert_fail("0", "s3_srvr_1a.cil.c", 3, "reach_error");
}
...
int main()
{
  ...
  unsigned long s__s3__tmp__new_cipher__algorithms = __VERIFIER_nondet_long("s__s3__tmp__new_cipher__algorithms");
  int buf;
  int cb;
  int blastFlag;
  int tmp___1;
