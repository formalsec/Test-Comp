...
void reach_error()
{
  __assert_fail("0", "s3_srvr_12.cil.c", 3, "reach_error");
}
...
int ssl3_accept(int initial_state)
{
  ...
  int __cil_tmp60;
  unsigned long __cil_tmp61 = __VERIFIER_nondet_ulong("__cil_tmp61");
  {
...

    {
      while (1)
      {
                                                                          ...
                                                                          else
                                                                          {
                                                                            ...
                                                                            else
                                                                            {
                                                                              ...
                                                                              if (0)
                                                                              {
                                                                                ...
                                                                                {
                                                                                  s__s3__tmp__new_cipher__algorithms = __VERIFIER_nondet_int("s__s3__tmp__new_cipher__algorithms");
                                                                                      ...
                                                                                      {
                                                                                        {
                                                                                          ...
                                                                                          s__s3__tmp__new_cipher__algo_strength = __VERIFIER_nondet_int("s__s3__tmp__new_cipher__algo_strength");
        ...
        s__s3__tmp__reuse_message = __VERIFIER_nondet_int("s__s3__tmp__reuse_message");
