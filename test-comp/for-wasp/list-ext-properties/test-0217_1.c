...
item_p create_item(end_point_t at, item_p *cursor)
{
  ...
  int y = 1;
  int h = 2;
  while (__logand(__logand(*cursor, (*(*cursor))[link_field]), y))
  {
...
int main()
{
  ...
  int z = 0;
  int length = 0;
  while (__logand(i < 3, __VERIFIER_nondet_int("while_1")))
  {
    while (__logand(y < 4, __VERIFIER_nondet_int("while_2")))
    {
    ...
    while (__logand(z < 7, __VERIFIER_nondet_int("while_3")))
    {
