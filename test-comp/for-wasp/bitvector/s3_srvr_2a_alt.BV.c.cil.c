...
int ssl3_accept(int initial_state)
{
  ...
  unsigned int s__verify_mode = __VERIFIER_nondet_uint("s__verify_mode");
  ...
  unsigned int tmp___6 = __VERIFIER_nondet_uint("tmp___6");
  int tmp___7;
  ...
  int blastFlag;
  int ag_X = __VERIFIER_nondet_int("ag_X");
  int ag_Y;
  int __retres69;
  {
