...
int ssl3_accept(int initial_state)
{
  ...
  unsigned int s__ctx__stats__sess_accept_good = __VERIFIER_nondet_uint("s__ctx__stats__sess_accept_good");
  ...
  int buf = __VERIFIER_nondet_int("buf");
  unsigned long l;
  unsigned long Time;
  unsigned long tmp = __VERIFIER_nondet_ulong("tmp");
  int cb;
  long num1;
  int ret;
  int new_state;
                                                                            ...
                                                                            {
                                                                              {
                                                                                ...
                                                                                if (0)
                                                                                {
                                                                                    ...
                                                                                    else
                                                                                    {
                                                                                      if (l & 1UL)
                                                                                      {
                                                                                        ...
                                                                                        else
                                                                                        {
                                                                                          ...
                                                                                          {
                                                                                            tmp___6 = __VERIFIER_nondet_uint("tmp___6");
                                                                                  ...
                                                                                  goto switch_1_break;
                                                                                  switch_1_8448:
                                                                                  num1 = __VERIFIER_nondet_int("num1");
                                                                                  ...
                                                                                  tmp___9 = __VERIFIER_nondet_int("tmp___9");
                                                                                  if (!tmp___9)
                                                                                  {
                                                                                    ret = -1;
                                                                                    goto end;
                                                                                  ...
                                                                                  s__state = 8672;
                                                                                  s__init_num = 0;
                                                                                  tmp___10 = __VERIFIER_nondet_int("tmp___10");
                                                                                  if (!tmp___10)
                                                                                  {
                                                                                    ret = -1;
                                                                                    goto end;
