...
void *main_thread(void *arg)
{
  ...
  unsigned char t3 = __VERIFIER_nondet_uchar("t3");
  unsigned char t4 = __VERIFIER_nondet_uchar("t4");
  __CS_cs();
  if (__CS_ret != 0)
    return 0;
...
int main()
{
  ...
  for (i = 0; i < 2; i++)
  {
    __CS_cp_w[i] = __VERIFIER_nondet_int("__CS_cp_w[i]");
    __CS_cp_r[i] = __VERIFIER_nondet_int("__CS_cp_r[i]");
    __CS_cp_x[i] = __VERIFIER_nondet_int("__CS_cp_x[i]");
    __CS_cp_y[i] = __VERIFIER_nondet_int("__CS_cp_y[i]");
    for (j = 0; j < 5; j++)
    {
