...
void *t1(void *arg)
{
	...
	if (enqueue_flag[__CS_round])
	{
		...
		{
			__CS_cs(); if (__CS_ret != 0) return 0;
			value = __VERIFIER_nondet_int("value");
			__CS_cs(); if (__CS_ret != 0) return 0;
...
int main(void)
{
	...
	for(i = 0; i < 2; i++) {
	  ...
	  __CS_cp_enqueue_flag[i] = __VERIFIER_nondet_bool("__CS_cp_enqueue_flag[i]");
	  __CS_cp_dequeue_flag[i] = __VERIFIER_nondet_bool("__CS_cp_dequeue_flag[i]");
	  __CS_cp_queue[i].head = __VERIFIER_nondet_int("head");
	  __CS_cp_queue[i].tail = __VERIFIER_nondet_int("tail");
	  __CS_cp_queue[i].amount = __VERIFIER_nondet_int("amount");
	  for(j = 0; j < 20; j++) {
	    __CS_cp_queue[i].element[j] = __VERIFIER_nondet_int("element[j]");
	  }
	  for(j = 0; j < 3; j++) {
	  ...
	  for (j = 0; j < 20; j++) {
	    __CS_cp_stored_elements[i][j] = __VERIFIER_nondet_int("__CS_cp_stored_elements[i][j]");
	  }
	}
