...
void reach_error()
{
  __assert_fail("0", "double_req_bl_0683a.c", 3, "reach_error");
}
...
static const double atanhi_atan[] = {4.63647609000806093515e-01, 7.85398163397448278999e-01, 9.82793723247329054082e-01, 1.57079632679489655800e+00};
static const double atanlo_atan[] = {2.26987774529616870924e-17, 3.06161699786838301793e-17, 1.39033110312309984516e-17, 6.12323399573676603587e-17};
static const double aT_atan[] = {3.33333333333329318027e-01, -1.99999999998764832476e-01, 1.42857142725034663711e-01, -1.11111104054623557880e-01, 9.09088713343650656196e-02, -7.69187620504482999495e-02, 6.66107313738753120669e-02, -5.83357013379057348645e-02, 4.97687799461593236017e-02, -3.65315727442169155270e-02, 1.62858201153657823623e-02};
...
static const double huge_atan = 1.0e300;
double atan_double(double x)
{
  ...
  if (ix >= 0x44100000)
  {
    ...
    while (0);
    if (__logor(ix > 0x7ff00000, __logand(ix == 0x7ff00000, low != 0)))
      return x + x;
...
static const double zero_atan2 = 0.0;
static const double pi_lo_atan2 = 1.2246467991473531772E-16;
double __ieee754_atan2(double y, double x)
{
  ...
  while (0);
  iy = hy & 0x7fffffff;
  if (__logor((ix | ((lx | (-lx)) >> 31)) > 0x7ff00000, (iy | ((ly | (-ly)) >> 31)) > 0x7ff00000))
    return x + y;
...
{
  double x = 1.0 / 0.0;
  double y = __VERIFIER_nondet_double("y");
  if (__logand(__logand(isinf_double(x), isfinite_double(y)), y < 0.0))
  {
