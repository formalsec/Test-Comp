...
void reach_error()
{
  __assert_fail("0", "double_req_bl_0870b.c", 3, "reach_error");
}
...
static const double dp_h_pow[] = {0.0, 5.84962487220764160156e-01};
static const double dp_l_pow[] = {0.0, 1.35003920212974897128e-08};
static const double zero_pow = 0.0;
static const double one_pow = 1.0;
static const double two_pow = 2.0;
...
double __ieee754_pow(double x, double y)
{
  ...
  if (__logor(__logor(__logor(ix > 0x7ff00000, __logand(ix == 0x7ff00000, lx != 0)), iy > 0x7ff00000), __logand(iy == 0x7ff00000, ly != 0)))
  {
  ...
  if (lx == 0)
  {
    if (__logor(__logor(ix == 0x7ff00000, ix == 0), ix == 0x3ff00000))
    {
      z = ax;
      if (hy < 0)
        z = one_pow / z;
