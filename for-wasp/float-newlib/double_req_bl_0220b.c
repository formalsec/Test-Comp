...
void reach_error()
{
  __assert_fail("0", "double_req_bl_0220b.c", 3, "reach_error");
}
...
static const double PIo2_krempio[] = {1.57079625129699707031e+00, 7.54978941586159635335e-08, 5.39030252995776476554e-15, 3.28200341580791294123e-22, 1.27065575308067607349e-29, 1.22933308981111328932e-36, 2.73370053816464559624e-44, 2.16741683877804819444e-51};
static const double zero_krempio = 0.0;
static const double one_krempio = 1.0;
static const double two24_krempio = 1.67772160000000000000e+07;
static const double twon24_krempio = 5.96046447753906250000e-08;
int __kernel_rem_pio2(double *x, double *y, int e0, int nx, int prec, const __int32_t *ipio2)
{
  ...
  for (i = jz; i >= 0; i--)
  {
    for (fw = 0.0, k = 0; __logand(k <= jp, k <= (jz - i)); k++)
...
static const double half_rempio = 5.00000000000000000000e-01;
static const double two24_rempio = 1.67772160000000000000e+07;
static const double invpio2_rempio = 6.36619772367581382433e-01;
static const double pio2_1_rempio = 1.57079632673412561417e+00;
static const double pio2_1t_rempio = 6.07710050650619224932e-11;
static const double pio2_2_rempio = 6.07710050630396597660e-11;
static const double pio2_2t_rempio = 2.02226624879595063154e-21;
static const double pio2_3_rempio = 2.02226624871116645580e-21;
static const double pio2_3t_rempio = 8.47842766036889956997e-32;
__int32_t __ieee754_rem_pio2(double x, double *y)
{
  ...
  if (ix <= 0x413921fb)
  {
    ...
    w = fn * pio2_1t_rempio;
    if (__logand(n < 32, ix != npio2_hw_rempio[n - 1]))
    {
      y[0] = r - w;
    }
    else
...
static const double C1_kcos = 4.16666666666666019037e-02;
static const double C2_kcos = -1.38888888888741095749e-03;
static const double C3_kcos = 2.48015872894767294178e-05;
static const double C4_kcos = -2.75573143513906633035e-07;
static const double C5_kcos = 2.08757232129817482790e-09;
static const double C6_kcos = -1.13596475577881948265e-11;
...
static const double S1_ksin = -1.66666666666666324348e-01;
static const double S2_ksin = 8.33333333332248946124e-03;
static const double S3_ksin = -1.98412698298579493134e-04;
static const double S4_ksin = 2.75573137070700676789e-06;
static const double S5_ksin = -2.50507602534068634195e-08;
static const double S6_ksin = 1.58969099521155010221e-10;
...
int main()
{
  ...
  if (!__logand(res == (-0.0), __signbit_double(res) == 1))
  {
    {
      reach_error();
    }
