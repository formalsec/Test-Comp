...
void reach_error()
{
  __assert_fail("0", "kbfiltr.i.cil-2.c", 3, "reach_error");
}
...
int main(void)
{
  ...
  stack[0].MajorFunction = __VERIFIER_nondet_uchar("MajorFunction");
  stack[1].MajorFunction = __VERIFIER_nondet_uchar("MajorFunction");
  stack[2].MajorFunction = __VERIFIER_nondet_uchar("MajorFunction");
  stack[0].MinorFunction = __VERIFIER_nondet_uchar("MinorFunction");
  stack[1].MinorFunction = __VERIFIER_nondet_uchar("MinorFunction");
  stack[2].MinorFunction = __VERIFIER_nondet_uchar("MinorFunction");
  ...
  stack[0].Parameters.DeviceIoControl.InputBufferLength = __VERIFIER_nondet_ulong("InputBufferLength");
  stack[1].Parameters.DeviceIoControl.InputBufferLength = __VERIFIER_nondet_ulong("InputBufferLength");
  stack[2].Parameters.DeviceIoControl.InputBufferLength = __VERIFIER_nondet_ulong("InputBufferLength");
  stack[0].Parameters.DeviceIoControl.IoControlCode = __VERIFIER_nondet_ulong("IoControlCode");
  stack[1].Parameters.DeviceIoControl.IoControlCode = __VERIFIER_nondet_ulong("IoControlCode");
  stack[2].Parameters.DeviceIoControl.IoControlCode = __VERIFIER_nondet_ulong("IoControlCode");
