...
{ SSL *s ;
  ...
  s->options = __VERIFIER_nondet_ulong("options");
  s->verify_mode = __VERIFIER_nondet_int("verify_mode");
  (s->session)->peer = (struct x509_st*) __VERIFIER_nondet_ulong("peer");
  (s->s3)->tmp.cert_request = __VERIFIER_nondet_int("cert_request");
  (s->s3)->tmp.new_cipher = malloc(sizeof(struct ssl_cipher_st));
  ((s->s3)->tmp.new_cipher)->algorithms = __VERIFIER_nondet_ulong("algorithms");
  ((s->s3)->tmp.new_cipher)->algo_strength = __VERIFIER_nondet_ulong("algo_strength");
  ...
  else
  {
    ...
    (s->cert)->pkeys[0].privatekey = (struct evp_pkey_st*) __VERIFIER_nondet_ulong("privatekey"); 
  }
