...
{ SSL *s = (SSL*)malloc(sizeof(SSL)) ;
  ...
  s->state = 12292;
  s->version = __VERIFIER_nondet_int("version");
	
	s->info_callback = (void (*)()) __VERIFIER_nondet_ulong("info_callback"); 
  (s->ctx)->info_callback = (void (*)()) __VERIFIER_nondet_ulong("info_callback"); 
  s->init_buf = (BUF_MEM *) __VERIFIER_nondet_ulong("init_buf");
  s->bbio = (BIO *) __VERIFIER_nondet_ulong("bbio");
  s->wbio = (BIO *) __VERIFIER_nondet_ulong("wbio");
  (s->s3)->flags = __VERIFIER_nondet_long("flags");
  (s->s3)->tmp.cert_req = __VERIFIER_nondet_int("cert_req");
  (s->s3)->tmp.new_cipher = malloc(sizeof(struct ssl_cipher_st));
  ((s->s3)->tmp.new_cipher)->algorithms = __VERIFIER_nondet_ulong("algorithms");
  (s->s3)->tmp.next_state = __VERIFIER_nondet_int("next_state");
...
int ssl3_connect(SSL *s ) 
{ BUF_MEM *buf = (BUF_MEM *) __VERIFIER_nondet_ulong("buf");
  unsigned long tmp ;
  unsigned long l ;
  long num1 ;
  void (*cb)() ;
  ...
  {
  blastFlag = 0; 
  s->hit = __VERIFIER_nondet_int ("hit");
  s->state = 12292;
                                                                  ...
                                                                  if (s->state == 4352) {
                                                                    ...
                                                                    if (s->state == 3) {
                                                                      ...
                                                                      if (0) {
                                                                        ...
                                                                        tmp___7 = __VERIFIER_nondet_int("tmp___7");
                                                                        if (! tmp___7) {
                                                                          ret = -1;
                                                                          goto end;
                                                                        } else {
                                                                        ...
                                                                        tmp___8 = __VERIFIER_nondet_int("tmp___8");
                                                                        if (! tmp___8) {
                                                                          ret = -1;
                                                                          goto end;
                                                                        } else {
...
SSL_METHOD *sslv3_base_method() {
  ...
  method->version = __VERIFIER_nondet_int("version");
  return method;
}
