...
struct sl *create_sl_with_head_and_tail(void)
{
  ...
  sl->tail->n3 = (sl->tail->n2 = (sl->tail->n1 = (void *) 0));
  return sl;
}
...
void sl_random_insert(struct sl *sl)
{
  ...
  struct sl_item *new;
  a3 = sl->head;
  while (__logand(a3->n3 != sl->tail, __VERIFIER_nondet_int("while_1")))
    a3 = a3->n3;

  a2 = a3;
  while (__logand(a2->n2 != a3->n3, __VERIFIER_nondet_int("while_2")))
    a2 = a2->n2;

  a1 = a2;
  while (__logand(a1->n1 != a2->n2, __VERIFIER_nondet_int("while_3")))
    a1 = a1->n1;
