...
void reach_error()
{
  __assert_fail("0", "aiob_4.c", 3, "reach_error");
}
...
extern FILE *fopen(const char *Id_MCDC_90, const char *Id_MCDC_91);
int main();
