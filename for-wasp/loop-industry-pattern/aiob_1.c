...
void reach_error()
{
  __assert_fail("0", "aiob_1.c", 3, "reach_error");
}
...
{
  UINT32 x = __VERIFIER_nondet_uint("x");
  return x;
}

void Id_MCDC_95(VLMODE *Id_MCDC_94);
extern FILE *fopen(const char *Id_MCDC_96, const char *Id_MCDC_97);
int main();
