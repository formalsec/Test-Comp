...
int ssl3_connect(void)
{
  ...
  unsigned int s__in_handshake = __VERIFIER_nondet_uint("s__in_handshake");
  int s__state;
  int s__new_session;
  int s__server;
  unsigned int s__version = __VERIFIER_nondet_uint("s__version");
  int s__type;
  int s__init_num;
  ...
  int s__rwstate;
  int s__init_buf___0 = __VERIFIER_nondet_int("s__init_buf___0");
  int s__debug = __VERIFIER_nondet_int("s__debug");
  int s__shutdown;
  int s__ctx__info_callback = __VERIFIER_nondet_int("s__ctx__info_callback");
  unsigned int s__ctx__stats__sess_connect_renegotiate = __VERIFIER_nondet_uint("s__ctx__stats__sess_connect_renegotiate");
  unsigned int s__ctx__stats__sess_connect = __VERIFIER_nondet_uint("s__ctx__stats__sess_connect");
  unsigned int s__ctx__stats__sess_hit = __VERIFIER_nondet_uint("s__ctx__stats__sess_hit");
  unsigned int s__ctx__stats__sess_connect_good = __VERIFIER_nondet_uint("s__ctx__stats__sess_connect_good");
  int s__s3__change_cipher_spec;
  int s__s3__flags = __VERIFIER_nondet_int("s__s3__flags");
  ...
  unsigned long tmp;
  unsigned long l;
  int num1 = __VERIFIER_nondet_int("num1");
  int cb;
  int ret;
  int new_state;
  int state;
  int skip;
  int tmp___0;
  unsigned int tmp___1 = __VERIFIER_nondet_uint("tmp___1");
  unsigned int tmp___2 = __VERIFIER_nondet_uint("tmp___2");
