...
{
  int DeviceObject__DeviceExtension = __VERIFIER_nondet_int("DeviceObject__DeviceExtension");
  int deviceExtension__WmilibContext = __VERIFIER_nondet_int("deviceExtension__WmilibContext");
  int Irp__IoStatus__Status;
  int status;
  int deviceExtension;
  int wmilibContext;
...
int DiskPerfIoCompletion(int DeviceObject, int Irp, int Context)
{
  ...
  int partitionCounters__BytesRead__QuadPart = __VERIFIER_nondet_int("partitionCounters__BytesRead__QuadPart");
  int Irp__IoStatus__Information = __VERIFIER_nondet_int("Irp__IoStatus__Information");
  int partitionCounters__ReadCount = __VERIFIER_nondet_int("partitionCounters__ReadCount");
  int partitionCounters__ReadTime__QuadPart = __VERIFIER_nondet_int("partitionCounters__ReadTime__QuadPart");
  int difference__QuadPart = __VERIFIER_nondet_int("difference__QuadPart");
  int partitionCounters__BytesWritten__QuadPart = __VERIFIER_nondet_int("partitionCounters__BytesWritten__QuadPart");
  int partitionCounters__WriteCount = __VERIFIER_nondet_int("partitionCounters__WriteCount");
  int partitionCounters__WriteTime__QuadPart = __VERIFIER_nondet_int("partitionCounters__WriteTime__QuadPart");
  int Irp__Flags = __VERIFIER_nondet_int("Irp__Flags");
  int partitionCounters__SplitCount = __VERIFIER_nondet_int("partitionCounters__SplitCount");
  int Irp__PendingReturned = __VERIFIER_nondet_int("Irp__PendingReturned");
  int Irp__Tail__Overlay__CurrentStackLocation__Control;
  int partitionCounters = __VERIFIER_nondet_int("partitionCounters");
  int queueLen = __VERIFIER_nondet_int("queueLen");
  {
...
int DiskPerfDeviceControl(int DeviceObject, int Irp)
{
  ...
  int sizeof__DISK_PERFORMANCE = __VERIFIER_nondet_int("sizeof__DISK_PERFORMANCE");
  int Irp__IoStatus__Information;
  int deviceExtension__DiskCounters = __VERIFIER_nondet_int("deviceExtension__DiskCounters");
  int Irp__AssociatedIrp__SystemBuffer = __VERIFIER_nondet_int("Irp__AssociatedIrp__SystemBuffer");
  int deviceExtension__Processors = __VERIFIER_nondet_int("deviceExtension__Processors");
  int totalCounters__QueueDepth;
  int deviceExtension__QueueDepth = __VERIFIER_nondet_int("deviceExtension__QueueDepth");
  int Irp__IoStatus__Status;
  int deviceExtension;
  int currentIrpStack;
  int status;
...
int DiskPerfRegisterDevice(int DeviceObject)
{
  int DeviceObject__DeviceExtension = __VERIFIER_nondet_int("DeviceObject__DeviceExtension");
  int deviceExtension__TargetDeviceObject = __VERIFIER_nondet_int("deviceExtension__TargetDeviceObject");
  int sizeof__number = __VERIFIER_nondet_int("sizeof__number");
  int ioStatus__Status = __VERIFIER_nondet_int("ioStatus__Status");
  int sizeof__VOLUME_NUMBER = __VERIFIER_nondet_int("sizeof__VOLUME_NUMBER");
  int volumeNumber__VolumeManagerName__0 = __VERIFIER_nondet_int("volumeNumber__VolumeManagerName__0");
  int status;
  int ioStatus = __VERIFIER_nondet_int("ioStatus");
  int event = __VERIFIER_nondet_int("event");
  int deviceExtension;
  int irp;
  int number = __VERIFIER_nondet_int("number");
  int registrationFlag;
  int sizeof__MOUNTDEV_NAME = __VERIFIER_nondet_int("sizeof__MOUNTDEV_NAME");
  int output__NameLength = __VERIFIER_nondet_int("output__NameLength");
  int outputSize;
  int output = __VERIFIER_nondet_int("output");
  int volumeNumber = __VERIFIER_nondet_int("volumeNumber");
  int __cil_tmp20;
  int __cil_tmp21;
  int __cil_tmp22;
  long __cil_tmp23;
...
int IoBuildDeviceIoControlRequest(int IoControlCode, int DeviceObject, int InputBuffer, int InputBufferLength, int OutputBuffer, int OutputBufferLength, int InternalDeviceIoControl, int Event, int IoStatusBlock)
{
  int malloc_ret = __VERIFIER_nondet_int("malloc_ret");
  {
    customIrp = 1;
    int tmp_ndt_7;
