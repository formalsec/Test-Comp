...
{
  int status;
  int threadHandle = __VERIFIER_nondet_int("threadHandle");
  int DisketteExtension__PoweringDown = __VERIFIER_nondet_int("DisketteExtension__PoweringDown");
  int DisketteExtension__ThreadReferenceCount = __VERIFIER_nondet_int("DisketteExtension__ThreadReferenceCount");
  int DisketteExtension__FloppyThread = __VERIFIER_nondet_int("DisketteExtension__FloppyThread");
  int Irp__IoStatus__Status;
  int Irp__IoStatus__Information;
  int Irp__Tail__Overlay__CurrentStackLocation__Control;
  int ObjAttributes = __VERIFIER_nondet_int("ObjAttributes");
  int __cil_tmp12;
  int __cil_tmp13;
  {
...
int FloppyPnp(int DeviceObject, int Irp)
{
  ...
  int disketteExtension__IsRemoved = __VERIFIER_nondet_int("disketteExtension__IsRemoved");
  int disketteExtension__IsStarted = __VERIFIER_nondet_int("disketteExtension__IsStarted");
  int disketteExtension__TargetObject = __VERIFIER_nondet_int("disketteExtension__TargetObject");
  int disketteExtension__HoldNewRequests;
  int disketteExtension__FloppyThread = __VERIFIER_nondet_int("disketteExtension__FloppyThread");
  int disketteExtension__InterfaceString__Buffer = __VERIFIER_nondet_int("disketteExtension__InterfaceString__Buffer");
  int disketteExtension__InterfaceString = __VERIFIER_nondet_int("disketteExtension__InterfaceString");
  int disketteExtension__ArcName__Length = __VERIFIER_nondet_int("disketteExtension__ArcName__Length");
  int disketteExtension__ArcName = __VERIFIER_nondet_int("disketteExtension__ArcName");
  int irpSp__MinorFunction = __VERIFIER_nondet_int("irpSp__MinorFunction");
  int IoGetConfigurationInformation__FloppyCount = __VERIFIER_nondet_int("IoGetConfigurationInformation__FloppyCount");
  int irpSp;
  int disketteExtension;
  int ntStatus;
  int doneEvent = __VERIFIER_nondet_int("doneEvent");
  int irpSp___0;
  int nextIrpSp;
...
int FloppyStartDevice(int DeviceObject, int Irp)
{
  ...
  int disketteExtension__DriveType = __VERIFIER_nondet_int("disketteExtension__DriveType");
  int disketteExtension__PerpendicularMode;
  int disketteExtension__DeviceUnit;
  int disketteExtension__DriveOnValue;
  int disketteExtension__UnderlyingPDO = __VERIFIER_nondet_int("disketteExtension__UnderlyingPDO");
  int disketteExtension__InterfaceString = __VERIFIER_nondet_int("disketteExtension__InterfaceString");
  ...
  int pnpStatus;
  int doneEvent = __VERIFIER_nondet_int("doneEvent");
  int fdcInfo = __VERIFIER_nondet_int("fdcInfo");
  int fdcInfo__BufferCount;
  int fdcInfo__BufferSize;
  int fdcInfo__MaxTransferSize = __VERIFIER_nondet_int("fdcInfo__MaxTransferSize");
  int fdcInfo__AcpiBios = __VERIFIER_nondet_int("fdcInfo__AcpiBios");
  int fdcInfo__AcpiFdiSupported = __VERIFIER_nondet_int("fdcInfo__AcpiFdiSupported");
  int fdcInfo__PeripheralNumber = __VERIFIER_nondet_int("fdcInfo__PeripheralNumber");
  int fdcInfo__BusType;
  int fdcInfo__ControllerNumber = __VERIFIER_nondet_int("fdcInfo__ControllerNumber");
  int fdcInfo__UnitNumber = __VERIFIER_nondet_int("fdcInfo__UnitNumber");
  int fdcInfo__BusNumber = __VERIFIER_nondet_int("fdcInfo__BusNumber");
  int Dc;
  int Fp;
  int disketteExtension;
  int irpSp;
  ...
  int irpSp__Context;
  int InterfaceType;
  int KUSER_SHARED_DATA__AlternativeArchitecture_NEC98x86 = __VERIFIER_nondet_int("KUSER_SHARED_DATA__AlternativeArchitecture_NEC98x86");
  long __cil_tmp42;
  int __cil_tmp43;
  int __cil_tmp44;
  int __cil_tmp45;
  int __cil_tmp46 = __VERIFIER_nondet_int("__cil_tmp46");
  int __cil_tmp47;
  int __cil_tmp48;
  int __cil_tmp49;
  {
...
int FlFdcDeviceIo(int DeviceObject, int Ioctl, int Data)
{
  ...
  int irpStack;
  int doneEvent = __VERIFIER_nondet_int("doneEvent");
  int ioStatus = __VERIFIER_nondet_int("ioStatus");
  int irp__Tail__Overlay__CurrentStackLocation = __VERIFIER_nondet_int("irp__Tail__Overlay__CurrentStackLocation");
...
int IoBuildDeviceIoControlRequest(int IoControlCode, int DeviceObject, int InputBuffer, int InputBufferLength, int OutputBuffer, int OutputBufferLength, int InternalDeviceIoControl, int Event, int IoStatusBlock)
{
  int malloc = __VERIFIER_nondet_int("malloc");
  {
    customIrp = 1;
    int tmp_ndt_5;
...
int IofCallDriver(int DeviceObject, int Irp)
{
  ...
  unsigned long __cil_tmp7;
  {
    ...
    {
      int tmp_ndt_11;
      tmp_ndt_11 = __VERIFIER_nondet_int("tmp_ndt_11");
      if (tmp_ndt_11 == 1)
      {
        goto switch_8_1;
      }
...
{
  {
    ...
    int tmp_ndt_12;
    tmp_ndt_12 = __VERIFIER_nondet_int("tmp_ndt_12");
    if (tmp_ndt_12 == 0)
    {
      goto switch_9_0;
    }
...
int ObReferenceObjectByHandle(int Handle, int DesiredAccess, int ObjectType, int AccessMode, int Object, int HandleInformation)
{
  {
    int tmp_ndt_13;
    tmp_ndt_13 = __VERIFIER_nondet_int("tmp_ndt_13");
    if (tmp_ndt_13 == 0)
    {
      goto switch_10_0;
    }
...
int PsCreateSystemThread(int ThreadHandle, int DesiredAccess, int ObjectAttributes, int ProcessHandle, int ClientId, int StartRoutine, int StartContext)
{
  {
    int tmp_ndt_14;
    tmp_ndt_14 = __VERIFIER_nondet_int("tmp_ndt_14");
    if (tmp_ndt_14 == 0)
    {
      goto switch_11_0;
    }
...
int ZwClose(int Handle)
{
  {
    int tmp_ndt_15;
    tmp_ndt_15 = __VERIFIER_nondet_int("tmp_ndt_15");
    if (tmp_ndt_15 == 0)
    {
      goto switch_12_0;
    }
...
int FloppyDeviceControl(int DeviceObject, int Irp)
{
  int disketteExtension__HoldNewRequests = __VERIFIER_nondet_int("disketteExtension__HoldNewRequests");
  int disketteExtension__IsRemoved = __VERIFIER_nondet_int("disketteExtension__IsRemoved");
  int Irp__IoStatus__Information;
  int disketteExtension__IsStarted = __VERIFIER_nondet_int("disketteExtension__IsStarted");
  int Irp__CurrentLocation = __VERIFIER_nondet_int("Irp__CurrentLocation");
  int Irp__Tail__Overlay__CurrentStackLocation = __VERIFIER_nondet_int("Irp__Tail__Overlay__CurrentStackLocation");
  int disketteExtension__TargetObject = __VERIFIER_nondet_int("disketteExtension__TargetObject");
  int irpSp__Parameters__DeviceIoControl__OutputBufferLength = __VERIFIER_nondet_int("irpSp__Parameters__DeviceIoControl__OutputBufferLength");
  int sizeof__MOUNTDEV_NAME = __VERIFIER_nondet_int("sizeof__MOUNTDEV_NAME");
  int Irp__AssociatedIrp__SystemBuffer = __VERIFIER_nondet_int("Irp__AssociatedIrp__SystemBuffer");
  int mountName__NameLength;
  int disketteExtension__DeviceName__Length = __VERIFIER_nondet_int("disketteExtension__DeviceName__Length");
  int sizeof__USHORT = __VERIFIER_nondet_int("sizeof__USHORT");
  int disketteExtension__InterfaceString__Buffer = __VERIFIER_nondet_int("disketteExtension__InterfaceString__Buffer");
  int uniqueId__UniqueIdLength;
  int disketteExtension__InterfaceString__Length = __VERIFIER_nondet_int("disketteExtension__InterfaceString__Length");
  int sizeof__MOUNTDEV_UNIQUE_ID = __VERIFIER_nondet_int("sizeof__MOUNTDEV_UNIQUE_ID");
  int irpSp__Parameters__DeviceIoControl__InputBufferLength = __VERIFIER_nondet_int("irpSp__Parameters__DeviceIoControl__InputBufferLength");
  int sizeof__FORMAT_PARAMETERS = __VERIFIER_nondet_int("sizeof__FORMAT_PARAMETERS");
  int irpSp__Parameters__DeviceIoControl__IoControlCode___1 = __VERIFIER_nondet_int("irpSp__Parameters__DeviceIoControl__IoControlCode___1");
  int sizeof__FORMAT_EX_PARAMETERS = __VERIFIER_nondet_int("sizeof__FORMAT_EX_PARAMETERS");
  int formatExParameters__FormatGapLength = __VERIFIER_nondet_int("formatExParameters__FormatGapLength");
  int formatExParameters__SectorsPerTrack = __VERIFIER_nondet_int("formatExParameters__SectorsPerTrack");
  int sizeof__DISK_GEOMETRY = __VERIFIER_nondet_int("sizeof__DISK_GEOMETRY");
  int Irp__IoStatus__Status___0;
  int disketteExtension = __VERIFIER_nondet_int("disketteExtension");
  int ntStatus;
  int outputBufferLength;
  int lowestDriveMediaType = __VERIFIER_nondet_int("lowestDriveMediaType");
  int highestDriveMediaType = __VERIFIER_nondet_int("highestDriveMediaType");
  int formatExParametersSize = __VERIFIER_nondet_int("formatExParametersSize");
  ...
  int __cil_tmp45 = __VERIFIER_nondet_int("__cil_tmp45");
  int __cil_tmp46;
  int __cil_tmp47;
  int __cil_tmp48;
  int __cil_tmp49;
  int __cil_tmp50 = __VERIFIER_nondet_int("__cil_tmp50");
  int __cil_tmp51;
  int __cil_tmp52;
  int __cil_tmp53;
  int __cil_tmp54;
  int __cil_tmp55 = __VERIFIER_nondet_int("__cil_tmp55");
  int __cil_tmp56;
  int __cil_tmp57;
  int __cil_tmp58;
  int __cil_tmp59;
  int __cil_tmp60 = __VERIFIER_nondet_int("__cil_tmp60");
  int __cil_tmp61;
  int __cil_tmp62;
  int __cil_tmp63;
  int __cil_tmp64;
  int __cil_tmp65 = __VERIFIER_nondet_int("__cil_tmp65");
  int __cil_tmp66 = __VERIFIER_nondet_int("__cil_tmp66");
  int __cil_tmp67;
  int __cil_tmp68;
  int __cil_tmp69 = __VERIFIER_nondet_int("__cil_tmp69");
  int __cil_tmp70;
  int __cil_tmp71;
  int __cil_tmp72 = __VERIFIER_nondet_int("__cil_tmp72");
  int __cil_tmp73;
  int __cil_tmp74;
  int __cil_tmp75 = __VERIFIER_nondet_int("__cil_tmp75");
  int __cil_tmp76;
  int __cil_tmp77;
  int __cil_tmp78 = __VERIFIER_nondet_int("__cil_tmp78");
  int __cil_tmp79;
  int __cil_tmp80;
  int __cil_tmp81 = __VERIFIER_nondet_int("__cil_tmp81");
  int __cil_tmp82;
  int __cil_tmp83;
  int __cil_tmp84;
  int __cil_tmp85;
  int __cil_tmp86;
  int __cil_tmp87;
  int __cil_tmp88 = __VERIFIER_nondet_int("__cil_tmp88");
  int __cil_tmp89;
  int __cil_tmp90;
  long __cil_tmp91;
  {
...
int FlCheckFormatParameters(int DisketteExtension, int FormatParameters)
{
  int DriveMediaConstants__driveMediaType__MediaType = __VERIFIER_nondet_int("DriveMediaConstants__driveMediaType__MediaType");
  int FormatParameters__MediaType = __VERIFIER_nondet_int("FormatParameters__MediaType");
  int FAKE_CONDITION = __VERIFIER_nondet_int("FAKE_CONDITION");
  {
